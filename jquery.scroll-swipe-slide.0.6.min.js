...
a(d).find(g.slides+":first-child").addClass("current");j+="</ul></nav>";h.scrollswipeslide.prepend(j);},slide_it:function(){var d=this;var c=d.settings;
if(d.direction){if(d.direction=="u"){if(a(c.slideshow_class).find(".active").prev(c.container).length>0){d.scrolling=true;d.go_to=a(c.slideshow_class).find(".active").prev(c.container);
