...
f.slide_vertical();}else{f.scrolling=false;}}else{if(f.direction=="r"&&e.multi_dir){if(a(e.container+":eq("+f.container+")").find(".current").next(e.slides).length>0){f.go_to=a(e.container+":eq("+f.container+")").find(".current").next(e.slides);
...
f.direction="d";f.slide_vertical();}else{f.scrolling=false;}}}else{if(f.direction=="l"&&e.multi_dir){if(a(e.container+":eq("+f.container+")").find(".current").prev(e.slides).length>0){f.go_to=a(e.container+":eq("+f.container+")").find(".current").prev(e.slides);
...
},750);c.this_scroll++;}return false;});},enable_swipe:function(){var c=this;settings=c.settings;a("body").on("swipeup",function(d){if(d.preventDefault){d.preventDefault();
...
var c=a(".project:eq("+e.go_to+")");e.cotainer=e.go_to;if(e.slide===0){e.top=true;e.bottom=false;}else{if(e.slide==a(d.nav).find(".slide-circle").length-1){e.bottom=true;
