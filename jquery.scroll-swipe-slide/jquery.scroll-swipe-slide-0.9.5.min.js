...
var h=j.settings;if(j.history&&j.scrolling||j.history&&j.row_switch){var c=j.current;var i=c.data("slug");var f=c.attr("id");var l=c.data();var k;if(h.base_title){if(h.base_title_pos==="before"){k=h.base_title+h.base_title_sep+c.data("title");
...
if(c==="u"){if(a(d.slideshow_class).find(".active").prev(d.container).length){e.scrolling=true;e.current=a(d.slideshow_class).find(".active").prev(d.container);
...
e.current=a(d.slideshow_class).find(".active").next(d.container);e.type="container";e.go_to=e.current.index();}else{e.scrolling=false;}}else{if(c==="l"&&d.multi_dir){if(a(d.container+":eq("+e.container+")").find(".current").prev(d.slides).length){e.scrolling=true;
e.type="slide";e.go_to=a(d.container+":eq("+e.container+")").find(".current").prev(d.slides);e.slide=e.go_to.index();}else{if(d.go_to_next_container&&a(d.container+":eq("+e.container+")").prev(d.container).length){e.row_switch=true;
...
}}}else{if(c==="r"&&d.multi_dir){if(a(d.container+":eq("+e.container+")").find(".current").next(d.slides).length){e.scrolling=true;e.type="slide";e.go_to=a(d.container+":eq("+e.container+")").find(".current").next(d.slides);
e.slide=e.go_to.index();}else{if(d.go_to_next_container&&a(d.container+":eq("+e.container+")").next(d.container).length){e.row_switch=true;e.current=a(d.container+":eq("+e.container+")").next(d.container);
e.type="container";e.go_to=e.current.index();e.direction="d";}else{e.scrolling=false;}}}}}}e.update_history();}else{return false;}},switch_nav:function(e){var f=this;
var c=f.settings;var d=a(c.nav).find(".slide-circle:eq("+e+")");if(!d.hasClass("active")){d.parent().find(".active").removeClass("active");d.addClass("active");
f.current=a(c.container+":eq("+e+")");f.move_to();}else{return false;}},move_to:function(){var e=this;var d=e.settings;var c=a(d.container+":eq("+e.go_to+")");
